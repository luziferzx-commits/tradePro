...
def run_optimization():
    print("--- Starting Threshold Sweep Tuning for XAUUSDm ---")
    ...
    tm = 12
    spw = 1.0
    thresholds = [0.50, 0.505, 0.51, 0.515, 0.52]
    test_months = 3
    
    print(f"Using Train={tm}m, SPW={spw}")
    ...
    while True:
        ...
        for th in thresholds:
            ...
            if m["pf"] > 1.3 and m["max_dd"] < 15 and m["trades"] >= 2: # Lowered pass req slightly for testing
                c["passed_windows"] += 1
    ...
    print("\n=================================================================================================================")
    print("                                WALK FORWARD THRESHOLD SWEEP RESULTS                                             ")
    print("=================================================================================================================")
    print(f"{'Thrsh':<5} | {'Trd':<4} | {'TPM':<5} | {'Win%':<6} | {'PF':<5} | {'NetProf':<7} | {'MaxDD%':<6} | {'ConsLoss':<8} | {'PassWin'}")
    print("-" * 105)
    ...
    for r in results:
        ...
        print(f"{r['Thresh']:<5.3f} | {r['Trades']:<4} | {tpm_str:<5} | {win_str:>5} | {pf_str:>4} | {np_str:>7} | {dd_str:>5} | {r['MaxLossStreak']:<8} | {r['PassedWin']}")
