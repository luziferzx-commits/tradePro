...
def run_optimization():
    print("--- Starting SPW Middle Ground Tuning for XAUUSDm ---")
    ...
    tm = 12
    th = 0.52
    spw_list = [1.2, 1.5, 2.0, 2.5, 3.0]
    test_months = 3
    
    results = []
    
    for spw in spw_list:
        print(f"\nEvaluating SPW={spw} (Train={tm}m, Threshold={th})")
    ...
    print("\n=================================================================================================================")
    print("                                WALK FORWARD MIDDLE GROUND RESULTS                                               ")
    print("=================================================================================================================")
    print(f"{'SPW':<5} | {'Trd':<4} | {'TPM':<5} | {'Win%':<6} | {'PF':<5} | {'NetProf':<7} | {'MaxDD%':<6} | {'ConsLoss':<8} | {'PassWin'}")
    print("-" * 105)
    ...
    for r in results:
        ...
        print(f"{r['SPW']:<5.1f} | {r['Trades']:<4} | {tpm_str:<5} | {win_str:>5} | {pf_str:>4} | {np_str:>7} | {dd_str:>5} | {r['MaxLossStreak']:<8} | {r['PassedWin']}")
