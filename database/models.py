...
class TradeRecord(Base):
    ...
    # ─── ✅ ใหม่ ─────────────────────────────────────────────
    session     = Column(String(20),  nullable=True)  # London, NY, Asia_Early, Asia_Late, Dead
    pattern_id  = Column(String(100), nullable=True)  # EvidenceRouter pattern_id
    strategy    = Column(String(50),  nullable=True)  # EVIDENCE_ROUTER, ABC_ROUTER, LEGACY
    # ──────────────────────────────────────────────────────────
